...
// Function to set the height of the order book chart container dynamically
function setChartHeight() {
	var windowHeight = window.innerHeight;
	var chartContainer = document.getElementById('orderbookchart');
	var chartHeight = windowHeight - chartContainer.offsetTop - 10; // Adjust for padding and margin
	chartContainer.style.height = chartHeight + 'px';
}

// Call the setChartHeight function when the window is resized
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function updateSymbolDropdown() {
        ...
        symbolDropdownContent.innerHTML = ''; // Clear existing content
    ...
    // Populate the symbol dropdown with radio buttons
    const symbolDropdownContent = document.querySelector('.symbol-dropdown-content');
    symbols.forEach(symbol => {
        const label = document.createElement('label');
        label.innerHTML = `<input type="radio" name="symbol" class="symbol" value="${symbol}"> ${symbol}`;
    ...
    async function fetchData() {
        ...
        // Calculate the total volume and percentages
    ...
    function updateChart(data) {
		...
		const exchangeColors = {
			'Ascendex': '#FFA500',       // Orange
			'Azbit': '#AA336A',          // Dark Magenta
			'Bequant': '#800080',        // Purple
			'BigOne': '#4B0082',         // Indigo
			'Binance': '#FFFF00',        // Yellow
			'BinanceUS': '#FFD700',      // Gold
			'Bitbns': '#DAA520',         // Goldenrod
			'Bitdelta': '#FFA07A',       // Light Salmon
			'Bitfinex': '#FF6347',       // Tomato
			'Bitget': '#FF4500',         // Orange Red
			'Bitmart': '#008000',        // Green
			'Bitso': '#00FF00',          // Lime
			'Bitstamp': '#7FFF00',       // Chartreuse
			'Bybit': '#000000',          // Black
			'Coinbase': '#000080',       // Navy
			'Coinex': '#00008B',         // Dark Blue
			'Delta': '#0000FF',          // Blue
			'Digifinex': '#4169E1',      // Royal Blue
			'Exmo': '#483D8B',           // Dark Slate Blue
			'Fmfw': '#800000',           // Maroon
			'Gateio': '#20B2AA',         // Light Sea Green
			'Hitbtc': '#9932CC',         // Dark Orchid
			'Huobi': '#FF00FF',          // Magenta
			'Kraken': '#00CED1',         // Dark Turquoise
			'Kucoin': '#FF7F50',         // Coral
			'Phemex': '#4682B4',         // Steel Blue
			'Poloniex': '#32CD32',       // Lime Green
			'Probit': '#556B2F',         // Dark Olive Green
			'MEXC': '#800000',           // Maroon
			'Wazirx': '#20B2AA',         // Light Sea Green
			'Whitebit': '#9932CC',       // Dark Orchid
			'Websea': '#FF00FF',         // Magenta
		};
        ...
        if (!chart) {
            chart = Highcharts.chart('orderbookchart', {
                chart: {
					...
					panKey: 'shift' // Set the key to be held down to pan
                },
                title: {
                    text: '',
                    style: {
                        fontSize: '11px' // Adjust font size for title
                    }
                },
                xAxis: {
                    type: 'treegrid', 
                    title: {
                        text: '',
                        style: {
                            fontSize: '11px' // Adjust font size for xAxis title
                        }
                    },
                    labels: {
                        style: {
                            fontSize: '11px' // Adjust font size for xAxis labels
                        }
                    },
                    reversed: false // Do not reverse xAxis
                },
                yAxis: {
                    visible: true,
					type: 'treegrid',
                    title: {
                        text: '',
                        style: {
                            fontSize: '11px' // Adjust font size for yAxis title
                        }
                    },
                    labels: {
                        style: {
                            fontSize: '11px' // Adjust font size for yAxis labels
                        }
                    },
                    reversed: false,
                    stackLabels: {
                        ...
                        style: {
                            fontWeight: 'bold',
                            color: 'gray',
                            fontSize: '11px' // Adjust font size for stack labels
                        }
                    }
                },
				tooltip: {
					...
					style: {
						fontSize: '11px' // Adjust font size for tooltip
					},
					shared: false, // Show tooltip only on mouse hover on individual bars
				},
                plotOptions: {
                    series: {
                        stacking: 'normal',
                        ...
                        dataLabels: {
                            style: {
                                fontSize: '11px' // Adjust font size for data labels
                            }
                        }
                    }
                },
                legend: {
                    itemStyle: {
                        fontSize: '7px' // Adjust font size for legend items
                    }
                },
                credits: {
                ...
                exporting: {
                    enabled: true // Disable the context menu
                },
                series: series
            });
